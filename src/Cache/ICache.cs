...
namespace Pingfan.Kit.Cache
{
    ...
    public interface ICache
    {
        ...
        /// </summary>
        bool TryGet<T>(string key, out T? result, T? defaultValue = default);
        ...
        /// 设置缓存的值和过期时间。
        /// </summary>
        void Set<T>(string key, T? data, float seconds) ;
        ...
        /// </summary>
        bool TryRemove<T>(string key, out T? result, T? defaultValue = default) ;
